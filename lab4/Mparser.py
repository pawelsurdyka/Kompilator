...
class Mparser(object):
    ...
    def p_matrix_element(self, p):
        ...
        """
        p[0] = AST.MatrixElement(AST.Variable(p[1]), p[3], p[5])

    def p_lvalue_matrix_element(self, p):
        """
        lvalue : matrix_element
        """
        p[0] = AST.LValue(matrix_element=p[1])

    def p_lvalue_id(self, p):
        """
        lvalue : ID
        """
        p[0] = AST.LValue(variable=AST.Variable(p[1]))
