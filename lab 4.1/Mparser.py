...
class Mparser(object):
    ...
    def p_program(self, p):
        ...
        program : statements
        """
        p[0] = AST.Program(p[1], line_no=p.lineno(1))

    def p_statements(self, p):
        """
        statements : statement
        """
        p[0] = AST.Statements(p[1], line_no=p.lineno(1))

    def p_statements2(self, p):
        """
        statements : statements statement
        """
        p[0] = AST.Statements(p[2], p[1], line_no=p.lineno(1))
    ...
    def p_assignment(self, p):
        ...
        """
        p[0] = AST.Assignment(p[1], p[2], p[3], line_no=p.lineno(1))
    ...
    def p_lvalue_matrix_element(self, p):
        ...
        """
        p[0] = AST.LValue(matrix_element=p[1], line_no=p.lineno(1))

    def p_lvalue_id(self, p):
        """
        lvalue : ID
        """
        p[0] = AST.LValue(variable=AST.Variable(p[1]), line_no=p.lineno(1))
    ...
    def p_expression(self, p):
        ...
        """
        p[0] = AST.BinaryExpression(p[2], p[1], p[3], line_no=p.lineno(1))

    def p_expression_in_par(self, p):
        """
        expression : LPAREN expression RPAREN
        """
        p[0] = AST.Expression(p[2], line_no=p.lineno(1))
    ...
    def p_expression_intnum(self, p):
        ...
        expression : INTNUM
        """
        p[0] = AST.IntNum(p[1], line_no=p.lineno(1))
    ...
    def p_expression_id(self, p):
        ...
        expression : ID
        """
        p[0] = AST.Variable(p[1], line_no=p.lineno(1))
    ...
    def p_expression_unary(self, p):
        ...
        """
        p[0] = AST.UnaryExpression(p[2], line_no=p.lineno(1))

    def p_expression_transpose(self, p):
        """
        expression : expression TRANSPOSE
        """
        p[0] = AST.Transpose(p[1], line_no=p.lineno(1))
    ...
    def p_condition(self, p):
        ...
        """
        p[0] = AST.Condition(p[2], p[1], p[3], line_no=p.lineno(1))
    ...
    def p_if_statement(self, p):
        ...
        """
        p[0] = AST.IfStatement(p[3], p[5], line_no=p.lineno(1))
    ...
    def p_while_loop(self, p):
        ...
        """
        p[0] = AST.WhileLoop(p[3], p[5], line_no=p.lineno(1))

    def p_for_loop(self, p):
        """
        for_loop : FOR ID ASSIGN range statement
        """
        p[0] = AST.ForLoop(AST.Variable(p[2]), p[4], p[5], line_no=p.lineno(1))

    def p_range(self, p):
        """
        range : expression COLON expression
        """
        p[0] = AST.Range(p[1], p[3], line_no=p.lineno(1))
    ...
    def p_return_statement(self, p):
        ...
        """
        p[0] = AST.ReturnStatement(line_no=p.lineno(1))

    def p_return_statement2(self, p):
        """
        return_statement : RETURN expression SEMICOLON
        """
        p[0] = AST.ReturnStatement(p[2], line_no=p.lineno(1))
